                                                ...
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <button class="btn btn-sm btn-info edit-item-btn"
                                                            ...
                                                            data-bs-target="#showModal{{ $comment->id }}">Chi tiết</button>
                                                    </div>
                                                    <div class="remove">
                                                        <form action="{{route('admin.comments.restore', $comment->id)}}" method="post">
                                                            @csrf
                                                            <button class="btn btn-sm btn-success remove-item-btn" type="submit">Hiện</button>
                                                        </form>
                                                    </div>
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#deleteRecordModal{{ $comment->id }}">Ẩn</button>
                                                    </div>
